              ...
              if (pluginInstance) {
                ...
                if (pluginId === 'obsidian-icon-folder' || pluginId === 'iconize') {
                  try {
                    ...
                    // Clear registered explorers cache so handleChangeLayout doesn't skip them
                    ...
                    // Remove old icon elements from DOM so new ones cleanly take their place
                    const fileExplorers = this.app.workspace.getLeavesOfType('file-explorer');
                    for (const fe of fileExplorers) {
                      const fileItems = (fe.view as any)?.fileItems;
                      if (fileItems) {
                        for (const folderPath of Object.keys(pluginInstance.data)) {
                          if (folderPath === 'settings') continue;
                    ...
                    // Second pass layout render with fresh nodes
                    if (pluginInstance.registeredFileExplorers && typeof pluginInstance.registeredFileExplorers.clear === 'function') {
                      pluginInstance.registeredFileExplorers.clear();
                    }
                    if (typeof pluginInstance.handleChangeLayout === 'function') {
                ...
                if (pluginId === 'obsidian-minimal-settings') {
                  try {
                    ...
                    const darkSchemes = [
                      "minimal-atom-dark", "minimal-ayu-dark", "minimal-catppuccin-dark", "minimal-default-dark",
                      "minimal-dracula-dark", "minimal-eink-dark", "minimal-everforest-dark", "minimal-flexoki-dark",
                      "minimal-gruvbox-dark", "minimal-macos-dark", "minimal-nord-dark", "minimal-notion-dark",
                      "minimal-rose-pine-dark", "minimal-solarized-dark", "minimal-things-dark"
                    ];
                    const lightSchemes = [
                      "minimal-atom-light", "minimal-ayu-light", "minimal-catppuccin-light", "minimal-default-light",
                      "minimal-eink-light", "minimal-everforest-light", "minimal-flexoki-light", "minimal-gruvbox-light",
                      "minimal-macos-light", "minimal-nord-light", "minimal-notion-light", "minimal-rose-pine-light",
                      "minimal-solarized-light", "minimal-things-light"
                    ];
